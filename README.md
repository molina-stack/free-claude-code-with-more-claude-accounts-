...
```bash
curl -fsSL "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.sh?raw=1" | sh
```

Windows PowerShell:

```powershell
irm "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.ps1?raw=1" | iex
```

Review the installers at [scripts/install.sh](https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.sh) and [scripts/install.ps1](https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.ps1). They install Claude Code and Codex when missing, then install or update the proxy. Re-run these commands to update to the latest version.
...
```bash
curl -fsSL "https://raw.githubusercontent.com/molina-stack/free-claude-code-with-more-claude-accounts-/main/scripts/uninstall.sh" | sh
```

Windows PowerShell:

```powershell
irm "https://raw.githubusercontent.com/molina-stack/free-claude-code-with-more-claude-accounts-/main/scripts/uninstall.ps1" | iex
```

Review [scripts/uninstall.sh](https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/uninstall.sh) and [scripts/uninstall.ps1](https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/uninstall.ps1). They remove the FCC uv tool and always delete `~/.fcc/`. Stop any running `fcc-server`, `fcc-claude`, `fcc-codex`, `fcc-init`, or `free-claude-code` process before uninstalling.
...
curl -fsSL "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-nim

# Local Whisper (CPU or CUDA)
curl -fsSL "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-local

# Both backends
curl -fsSL "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-all

# Local Whisper with CUDA
curl -fsSL "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.sh?raw=1" | sh -s -- --voice-local --torch-backend cu130
```
...
```powershell
# NVIDIA NIM transcription (Riva gRPC)
& ([scriptblock]::Create((irm "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.ps1?raw=1"))) -VoiceNim

# Local Whisper (CPU or CUDA)
& ([scriptblock]::Create((irm "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.ps1?raw=1"))) -VoiceLocal

# Both backends
& ([scriptblock]::Create((irm "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.ps1?raw=1"))) -VoiceAll

# Local Whisper with CUDA
& ([scriptblock]::Create((irm "https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/blob/main/scripts/install.ps1?raw=1"))) -VoiceLocal -TorchBackend cu130
```
...
```bash
git clone https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-.git
cd free-claude-code
...
- Report bugs and feature requests in [Issues](https://github.com/molina-stack/free-claude-code-with-more-claude-accounts-/issues). For bug always include all model mapping, current model when issue occured and the issue string
